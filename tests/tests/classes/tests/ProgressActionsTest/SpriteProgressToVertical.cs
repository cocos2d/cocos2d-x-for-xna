...
namespace tests
{
    public class SpriteProgressToVertical : SpriteDemo
    {
        ...
        public override void onEnter()
        {
            ...
            left.setType(CCProgressTimer.CCProgressTimerType.kCCProgressTimerTypeVerticalBarBT);
            addChild(left);
            ...
            right.setType(CCProgressTimer.CCProgressTimerType.kCCProgressTimerTypeVerticalBarTB);
            addChild(right);
