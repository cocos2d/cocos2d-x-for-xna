    ...
    public class SpriteTestScene : TestScene
    {
        ...
        public static CCLayer createSpriteTestLayer(int nIndex)
        {
            switch (nIndex)
            {
                ...
                case 111: return new SpriteFrameAliasNameTest();
                //case 4: return new SpriteAnchorPoint();
                //case 5: return new SpriteBatchNodeAnchorPoint();
                case 2: return new SpriteOffsetAnchorRotation();
                case 4: return new SpriteBatchNodeOffsetAnchorRotation();
                case 5: return new SpriteOffsetAnchorScale();
                case 6: return new SpriteBatchNodeOffsetAnchorScale();
                case 7: return new SpriteAnimationSplit();
                ...
                case 8: return new Sprite6();
                //case 22: return new SpriteFlip();
                //case 23: return new SpriteBatchNodeFlip();
                case 9: return new SpriteAliased();
                case 10: return new SpriteBatchNodeAliased();
                case 11: return new SpriteNewTexture();
                case 12: return new SpriteBatchNodeNewTexture();
                case 13: return new SpriteHybrid();
                case 14: return new SpriteBatchNodeChildren();
                case 15: return new SpriteBatchNodeChildren2();
                case 16: return new SpriteBatchNodeChildrenZ();
                case 17: return new SpriteChildrenVisibility();
                case 18: return new SpriteChildrenVisibilityIssue665();
                //case 34: return new SpriteChildrenAnchorPoint();
                //case 35: return new SpriteBatchNodeChildrenAnchorPoint();
                case 19: return new SpriteBatchNodeChildrenScale();
                case 20: return new SpriteChildrenChildren();
                case 21: return new SpriteBatchNodeChildrenChildren();
                case 22: return new SpriteNilTexture();
                case 23: return new SpriteSubclass();
                case 24: return new AnimationCache();
                case 25: return new SpriteOffsetAnchorSkew();
                //case 43: return new SpriteBatchNodeOffsetAnchorSkew();
                case 26: return new SpriteOffsetAnchorSkewScale();
                //case 45: return new SpriteBatchNodeOffsetAnchorSkewScale();
                case 27: return new SpriteOffsetAnchorFlip();
                case 3: return new SpriteBatchNodeOffsetAnchorFlip();
            }
